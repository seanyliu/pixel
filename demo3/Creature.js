function Creature() {
  ...
  this.velY = 0; // current
  this.GRAVITY = 31;
  this.VELOCITY_JUMP_MAX = -260;
  this.VELOCITY_JUMP_INCREMENT = -50;
  this.VELOCITY_X = 125;
  this.grounded = true;
  ...
  /**
   * Common collision function used by lots of
   * subclasses that have to implement collideGround
   */
  this.collideGround = function(/** GameObject */ other) {
